...
import { UserPlus, Trash2, ShieldCheck, ShieldAlert, CirclePlus, Activity, Calendar } from 'lucide-react';
...
const UserManagement = ({ user }) => {
  ...
  const handleCreatePatient = async (e) => {
    ...
    try {
      ...
      setPatientMessage("Error al crear acceso de paciente (El código podría estar duplicado)");
    }
  };
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="bg-white/80 backdrop-blur-md p-10 rounded-[2.5rem] shadow-sm border border-white">
        <h2 className="text-xl font-black text-slate-800 mb-6">Investigadores Activos</h2>
      ...
      <div className="bg-white/80 backdrop-blur-md p-10 rounded-[2.5rem] shadow-sm border border-white">
        <div className="flex items-center justify-between mb-8">
            <div className="flex items-center space-x-4">
                ...
                <h2 className="text-2xl font-black text-slate-800">Lista Maestra de Participantes</h2>
            </div>
            <span className="text-xs font-black bg-indigo-50 text-indigo-600 px-4 py-2 rounded-xl">
                Total: {allPatients.length} Registros
            </span>
        </div>
                ...
                <tr>
                    <td colSpan="4" className="px-8 py-20 text-center">
                        <div className="flex flex-col items-center space-y-3 opacity-20">
                            <Activity size={48} />
                            <p className="text-sm font-black uppercase tracking-widest">No hay participantes registrados aún</p>
                        </div>
                    </td>
                </tr>
              )}
